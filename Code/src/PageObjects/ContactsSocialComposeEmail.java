...
public class ContactsSocialComposeEmail implements Initializations {
    private WebDriver driver;

    public ContactsSocialComposeEmail(WebDriver driver) {
	this.driver = driver;
    }

    // Goto administration --> suggested posts
    public boolean composeExistingEmail() throws InterruptedException {
	...
	WebElement clickExistingEmailSocialPage = driver.findElement(composeExistingEmailSocialPage);
	clickExistingEmailSocialPage.click();
	Thread.sleep(SLEEP_WAIT_2000);
