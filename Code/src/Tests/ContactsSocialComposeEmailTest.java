...
import PageObjects.ContactsSocialComposeEmail;

public class ContactsSocialComposeEmailTest extends TestBaseSetup {
	...
	ContactsSocialComposeEmail socialComposerEmail = new ContactsSocialComposeEmail(driver);
