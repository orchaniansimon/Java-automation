...
import PageObjects.SocialComposerWriteYourOwnEmail;

public class SocialComposerWriteYourOwnEmailTest extends TestBaseSetup {
	...
	SocialComposerWriteYourOwnEmail socialComposerWriteYourOwnEmail = new SocialComposerWriteYourOwnEmail(driver);
